...
vi.mock('../hooks/useKeypress.js', () => ({
    useKeypress: vi.fn((_handler, _options) => {
...
describe('SettingsDialog', () => {
    ...
    describe('Initial Rendering', () => {
        it('should render the settings dialog with default state', () => {
            ...
            const { lastFrame } = render(_jsx(SettingsDialog, { settings: settings, onSelect: onSelect }));
    ...
    describe('Settings Navigation', () => {
        it('should navigate down with arrow key', async () => {
            const settings = createMockSettings();
            const onSelect = vi.fn();
            const { stdin, unmount } = render(_jsx(SettingsDialog, { settings: settings, onSelect: onSelect }));
            // Press down arrow
    ...
    describe('Scope Selection', () => {
        ...
        it('should reset to settings focus when scope is selected', async () => {
            const settings = createMockSettings();
            const onSelect = vi.fn();
            const { lastFrame, unmount } = render(_jsx(SettingsDialog, { settings: settings, onSelect: onSelect }));
    ...
    describe('Restart Prompt', () => {
        it('should show restart prompt for restart-required settings', async () => {
            ...
            const { unmount } = render(_jsx(SettingsDialog, { settings: settings, onSelect: () => { }, onRestartRequest: onRestartRequest }));
        ...
        it('should handle restart request when r is pressed', async () => {
            const settings = createMockSettings();
            const onRestartRequest = vi.fn();
            const { stdin, unmount } = render(_jsx(SettingsDialog, { settings: settings, onSelect: () => { }, onRestartRequest: onRestartRequest }));
    ...
    describe('VimMode Integration', () => {
        it('should sync with VimModeContext when vim mode is toggled', async () => {
            const settings = createMockSettings();
            const onSelect = vi.fn();
            const { stdin, unmount } = render(_jsx(VimModeProvider, { settings: settings, children: _jsx(SettingsDialog, { settings: settings, onSelect: onSelect }) }));
    ...
    describe('Specific Settings Behavior', () => {
        ...
        it('should clear restart prompt when switching scopes', async () => {
            const settings = createMockSettings();
            const onSelect = vi.fn();
            const { unmount } = render(_jsx(SettingsDialog, { settings: settings, onSelect: onSelect }));
